...
export const SHIP_LABELS: Record<
  LegacyShipId,
  { name: string; description: string }
> = {
  cargo_small: {
...
export const FACTION_LABELS: Record<
  FactionId,
  { name: string; description: string }
> = {
  ferride: {
...
export const WARSHIP_LABELS: Record<
  WarshipId,
  { name: string; description: string }
> = {
  fighter: {
...
export const CHASSIS_LABELS: Record<
  ChassisId,
  { name: string; description: string }
> = {
  scout_frame: {
...
export const DIRECTIVE_LABELS: Record<
  CombatDirective,
...
export const TECH_LABELS: Record<
  TechId,
  { name: string; description: string }
> = {
  metallurgy: {
