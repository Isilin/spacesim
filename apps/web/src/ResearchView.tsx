        ...
        <div className="research-graph">
          ...
          >
            ...
            {TECH_IDS.map((id) => {
              ...
              return (
                // a11y, non signalé par oxlint (chantier 48) : l'arbre technologique se clique sur des <g> SVG, sans équivalent clavier aujourd'hui. Biome 1.9 ne voyait pas ces cas ; les rendre navigables est un chantier d'accessibilité à part entière, pas une ligne de suppression.
                <g
                  key={id}
