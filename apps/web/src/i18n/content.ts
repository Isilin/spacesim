...
export const contentFr = {
  ...
  systemProfile: {
    unknown: "Inexploré",
    tight: "Binaire serrée",
    wide: "Binaire large",
    drifter: "Errant",
    and: " et ",
    several: "{{name}} ×{{count}}",
    worlds_one: "{{count}} monde",
    worlds_other: "{{count}} mondes",
    moonsSuffix_one: ", {{count}} lune",
    moonsSuffix_other: ", {{count}} lunes",
    belts_one: "{{count}} ceinture",
    belts_other: "{{count}} ceintures",
    exotic: "matière exotique",
  },
  planetClass: {
    rocky: "Rocheuse",
...
export const contentEn: typeof contentFr = {
  ...
  systemProfile: {
    ...
    and: " and ",
    several: "{{name}} ×{{count}}",
    worlds_one: "{{count}} world",
    worlds_other: "{{count}} worlds",
    moonsSuffix_one: ", {{count}} moon",
    moonsSuffix_other: ", {{count}} moons",
    belts_one: "{{count}} belt",
    belts_other: "{{count}} belts",
    exotic: "exotic matter",
  },
  planetClass: {
    rocky: "Rocky",
