#!/bin/sh
# Les node_modules vivent dans des volumes nommés, pour que les binaires Linux ne
# se mélangent jamais à l'hôte Windows (voir docker-compose.yml). Docker crée ces
...
for dir in /app/node_modules /app/packages/*/node_modules /app/apps/*/node_modules; do
